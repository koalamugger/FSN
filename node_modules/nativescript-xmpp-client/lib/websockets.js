...
var core = require('./deps/node-xmpp-core')
...
//var WebSocket = ws; //ws.Server ? ws : window.WebSocket
...
function WSConnection (opts) {
  ...
  this.appendW3CWebSocketInterface(WebSocket.prototype);
...
WSConnection.prototype.appendW3CWebSocketInterface = function (object) {
  if(typeof (object.onopen) === "undefined") return ;
  ['open', 'error', 'close', 'message'].forEach(function(method) {
    Object.defineProperty(object, 'on' + method, {

      get: function get() {
        var listener = this._callbacks[method][0];  
        return listener;
      },
      ...
      set: function set(listener) {
        this.removeEventListener(method);
